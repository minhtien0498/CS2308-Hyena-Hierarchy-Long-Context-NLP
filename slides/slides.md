...
- Ở chuỗi ngắn Hyena chậm hơn, vì chi phí FFT và đệm 2L lớn hơn phần tiết kiệm được. Hyena hòa ở khoảng `L = 512` và vượt lên từ `L = 1024`, đúng như lưu ý trong paper.
